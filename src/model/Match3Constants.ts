...
export const GAME_GOAL = [
    { id: 1, assets: [{ asset: 0, quantity: 3 }, { asset: 1, quantity: 3 }] },
    { id: 2, assets: [{ asset: 0, quantity: 10 }, { asset: 1, quantity: 10 }, { asset: 2, quantity: 10 }, { asset: 3, quantity: 10 }] },
    { id: 3, assets: [{ asset: 0, quantity: 10 }, { asset: 1, quantity: 10 }, { asset: 2, quantity: 10 }, { asset: 3, quantity: 10 }] },
]
