...
const DateIcon: React.FC<IconProps> = ({ date }) => {
  ...
  const calculateFontSize = () => {
    if (divRef.current) {
      ...
      const newFontSize = divWidth / 7; // 示例计算方法
  ...
  return (
    <div ref={divRef} style={{ display: "flex", alignItems: "center", width: "100%", height: "100%" }}>
      <svg id="Layer_1" width="25%" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <div style={{ width: "75%", overflow: "hidden", whiteSpace: "nowrap" }}>
